    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Sign in to your Orionix account</p>
        </div>
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="w-full mt-4 bg-white hover:bg-gray-100 text-gray-900 py-3 px-4 rounded-lg font-semibold transition flex items-center justify-center space-x-2"
          >
